...
public interface TBGlobals {
  ...
  CONFIGSTART = 8900, //
      ...
      ABOUT = 9001, OPER = 9002, MENU_TESTBED = 9031, QUIT = 9033, GRIDACTIVE = 9036, GRIDON = 9040,
      GRIDLABELS = 9041, GRIDSIZE = 9042, MOUSELOC = 9043,

      CTRLSVISIBLE = 9062, CONSOLEVISIBLE = 9063, BTN_TOGGLEWORKSPACE = 9066, AUXTABSET = 9067,
      AUXTAB_GRID = 9069, AUXTAB_TRACE = 9070,
